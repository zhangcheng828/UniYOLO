...
def kitti_data_prep(root_path,
    ...
    info_trainval_path = osp.join(out_dir,
                                  f'{info_prefix}_infos_trainval.pkl')
    info_test_path = osp.join(out_dir, f'{info_prefix}_infos_test.pkl')

    # kitti.create_reduced_point_cloud(root_path, info_prefix, info_train_path, info_val_path, info_test_path)
...
parser.add_argument(
    '--root-path',
    type=str,
    default='/mnt/goosefs/bjcar01/algorithm/public_data/det3d/',
