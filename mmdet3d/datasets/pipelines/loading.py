...
class LoadAnnotations3D(LoadAnnotations):
    ...
    def _load_depth_map(self, results):
        ...
        """
        file_name = results['ann_info']['depth_map']
        file_name = osp.join('depth_2', file_name)
        depth_map = cv2.imread(file_name, 0)
