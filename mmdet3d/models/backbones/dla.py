...
class DLA(nn.Module):
    ...
    def load_pretrained_model(self, data='imagenet', name='dla34', hash='ba72cf86'):
        if name == 'dla34':
            model_weights = torch.load('ckpts/dla34-ba72cf86.pth')
        elif name == 'dla60':
            model_weights = torch.load('checkpoints/dla60-24839fc4.pth')
        elif name == 'dla102':
            model_weights = torch.load('checkpoints/dla102-d94d9790.pth')
