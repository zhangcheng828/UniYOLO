...
def get_flex_keypoints(gt_bboxes_3d_list,
                  centers2d_list,
                  img_metas,
    ...
    for i in range(bs):
        ...
        centers2d = centers2d_list[i].to(gt_bboxes_3d.device)
        ...
        keypoints2d = keypoints2d * 0.25
        centers2d = centers2d * 0.25
        if use_local_coords:
            keypoints2d = keypoints2d - centers2d.unsqueeze(1).int()

        keypoints2d_list.append(keypoints2d)
        keypoints_mask_list.append(keypoints_visible)
        keypoints_depth_mask_list.append(keypoints_depth_valid)

    return (keypoints2d_list, keypoints_mask_list, keypoints_depth_mask_list)
